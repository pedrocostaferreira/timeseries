...
# Seção 7.3 - Correlação serial ---------------------------------------------------------------------------

  # Subseção 7.3.3 - Exemplo com dados artificiais
...
# Seção 7.6 - Aplicação à expectativa de inflação dos consumidores ----------------------------------------

  # Lendo os dados diretamente do github
  url_dados <- 'https://raw.githubusercontent.com/pedrocostaferreira/Analise-de-Series-Temporais-em-R/master/cap7-regressao-dinamica/cap7_dados.csv'
